...
<head runat="server">
	...
	<title>Eagle Flight Microfinance Bank | <?=$_SESSION['session_fullname'];?> | Balance</title>
	...
	<div id="content">
		<div class="cnt-header">
			<div class="breadcrumbs">
				<h2><a href="User/index">Dashboard</a> / <a href="User/balance">Check Balance</a></h2>
		...
		<div class="cnt-body">
			<div class="cnt-wrap-signup">
				<dl class="form">
					<form action="User/balance" method="post">
					<?=$stat?>
					</form>
				</dl>
			</div>
