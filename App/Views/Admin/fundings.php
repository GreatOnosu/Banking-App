...
<head runat="server">
	...
	<title>Eagle Flight Microfinance Bank | Admin | Fundings</title>
	...
	<div id="content">
		<div class="cnt-header">
			<div class="breadcrumbs">
				<h2><a href="Admin/index">Dashboard</a> / <a href="Admin/fundings">Fund Accounts</a></h2>
		...
		<div class="cnt-body">
			<div class="cnt-wrap-signup">
				<dl class="form">
					<?=$stat?>
					<form action="Admin/fundings" method="post">
					...
					<dt class="form-control">
						...
						<input type="number" id="acctno" name="acct_no" required /><span id="info">Account Name</span>
					</dt>
					<dt class="form-control">
					...
					<dt class="form-control">
						<input type="submit" value="Make Payment" name="btn_fund" />
					</dt>
					</form>
				</dl>
			</div>
